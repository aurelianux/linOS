...
export const translations = {
  de: {
    ...
    "infra.viewLogs": "Logs anzeigen",
    "infra.containers": "Container",
    "infra.ungrouped": "Sonstige",
    "infra.reconnecting": "Verbindung wird wiederhergestellt…",
    "infra.stackBuild": "Rebuild",
    "infra.stackBuildHint": "docker compose up --build -d (im Hintergrund)",
    "infra.stackBuilding": "Gestartet…",
    "infra.stackBuildSuccess": "Build gestartet",
    "infra.stackBuildError": "Build fehlgeschlagen",
    "infra.stackUp": "Up",
    "infra.stackUpHint": "docker compose up -d",
    "infra.stackUpping": "Startet…",
    "infra.stackUpSuccess": "Gestartet",
    "infra.stackUpError": "Start fehlgeschlagen",
    "infra.stackDown": "Down",
    "infra.stackDownHint": "docker compose down",
    "infra.stackDowning": "Stoppt…",
    "infra.stackDownSuccess": "Gestoppt",
    "infra.stackDownError": "Stop fehlgeschlagen",
    ...
    "quickToggle.mode.dunkel": "Dunkel",
    ...
    "vacuum.title": "Staubsauger",
    "vacuum.segment": "Segment",
    "vacuum.addSegment": "Segment hinzufügen",
    "vacuum.save": "Speichern",
    "vacuum.edit": "Bearbeiten",
    "vacuum.delete": "Entfernen",
    "vacuum.scheduleStart": "Startzeit",
    "vacuum.stepProgress": "Schritt {current} von {total}",
    ...
    "vacuum.schedule.now": "Jetzt",
    "vacuum.schedule.plus10m": "+10 min",
    "vacuum.schedule.plus30m": "+30 min",
    "vacuum.schedule.plus1h": "+1 h",
    "vacuum.schedule.plus2h": "+2 h",
    ...
    "admin.actions.restartSuccess": "Neugestartet",
    "admin.actions.restartError": "Neustart fehlgeschlagen",
    "admin.actions.reconnecting": "Verbindung wird wiederhergestellt…",
    "admin.actions.gitPull": "Git Pull",
    "admin.actions.gitPulling": "Pull läuft…",
    "admin.actions.gitPullSuccess": "Pull erfolgreich",
    "admin.actions.gitPullError": "Pull fehlgeschlagen",
    "admin.actions.gitStatus": "Repository",
    "admin.actions.gitBranch": "Branch",
    "admin.actions.gitCommit": "Letzter Commit",
    "admin.actions.gitAhead": "voraus",
    "admin.actions.gitBehind": "zurück",
    "admin.actions.gitDirty": "geänderte Dateien",
    "admin.actions.gitUntracked": "ungetrackt",
    "admin.actions.gitClean": "Sauber",
    "admin.actions.noStacks": "Keine Stacks konfiguriert.",
  ...
  en: {
    ...
    "infra.viewLogs": "View logs",
    "infra.containers": "containers",
    "infra.ungrouped": "Other",
    "infra.reconnecting": "Reconnecting…",
    "infra.stackBuild": "Rebuild",
    "infra.stackBuildHint": "docker compose up --build -d (background)",
    "infra.stackBuilding": "Initiated…",
    "infra.stackBuildSuccess": "Build initiated",
    "infra.stackBuildError": "Build failed to start",
    "infra.stackUp": "Up",
    "infra.stackUpHint": "docker compose up -d",
    "infra.stackUpping": "Starting…",
    "infra.stackUpSuccess": "Started",
    "infra.stackUpError": "Start failed",
    "infra.stackDown": "Down",
    "infra.stackDownHint": "docker compose down",
    "infra.stackDowning": "Stopping…",
    "infra.stackDownSuccess": "Stopped",
    "infra.stackDownError": "Stop failed",
    ...
    "vacuum.title": "Vacuum",
    "vacuum.segment": "Segment",
    "vacuum.addSegment": "Add Segment",
    "vacuum.save": "Save",
    "vacuum.edit": "Edit",
    "vacuum.delete": "Remove",
    "vacuum.scheduleStart": "Schedule Start",
    "vacuum.stepProgress": "Step {current} of {total}",
    ...
    "admin.actions.restarting": "Restarting…",
    "admin.actions.restartSuccess": "Restarted",
    "admin.actions.restartError": "Restart failed",
    "admin.actions.reconnecting": "Reconnecting…",
    "admin.actions.gitPull": "Git Pull",
    "admin.actions.gitPulling": "Pulling…",
    "admin.actions.gitPullSuccess": "Pull successful",
    "admin.actions.gitPullError": "Pull failed",
    "admin.actions.gitStatus": "Repository",
    "admin.actions.gitBranch": "Branch",
    "admin.actions.gitCommit": "Last Commit",
    "admin.actions.gitAhead": "ahead",
    "admin.actions.gitBehind": "behind",
    "admin.actions.gitDirty": "changed files",
    "admin.actions.gitUntracked": "untracked",
    "admin.actions.gitClean": "Clean",
    "admin.actions.noStacks": "No stacks configured.",
